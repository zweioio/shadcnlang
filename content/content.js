...
function initToggleButton() {
  ...
  toggleBtn.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
    <rect x="2" y="3" width="20" height="18" rx="2"/>
    <text x="7" y="15" font-size="10" font-family="serif" fill="currentColor" stroke="none">文</text>
    <text x="13" y="15" font-size="10" font-family="sans-serif" fill="currentColor" stroke="none">A</text>
  </svg>`;
